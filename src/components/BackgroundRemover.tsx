...
export default function BackgroundRemover() {
  ...
  return (
    <div className={`bg-gray-900 ${!originalImage ? 'min-h-0' : 'min-h-screen'}`}>
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${!originalImage ? 'py-8' : 'py-12'}`}>
        <div className={`text-center ${!originalImage ? 'mb-8' : 'mb-12'}`}>
        ...
        <div className={`${!originalImage ? 'mt-6' : 'mt-8'} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6`}>
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-100 mb-2">1. Upload</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-100 mb-2">2. Process</h3>
            <p className="text-gray-300">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-gray-100 mb-2">3. Download</h3>
            <p className="text-gray-300">
