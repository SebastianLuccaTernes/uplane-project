...
export default function BackgroundRemover() {
  ...
  return (
    <div className={`${!originalImage ? 'min-h-0' : 'min-h-screen'}`} style={{ backgroundColor: '#000000' }}>
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${!originalImage ? 'py-8' : 'py-12'}`}>
        ...
        {!originalImage ? (
          ...
          <div className="space-y-8">
            ...
            <div className="flex justify-center">
              <motion.button
                onClick={handleReset}
                className="hover:bg-gray-800 text-white font-medium px-6 py-3 rounded-lg transition-colors"
        ...
        <div className={`${!originalImage ? 'mt-6' : 'mt-8'} grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6`}>
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-medium text-white mb-2">2. Process</h3>
            <p className="text-gray-300">
